export default {
  ...
  colors: {
    light: {
      ...
      "button/regular-primary-text":
        "rgba(224.4, 229.5, 234.6, 0.949999988079071)",
      ...
      "search-section/options-text":
        "rgba(223.13, 229.28, 235.87, 0.949999988079071)",
    ...
    dark: {
      ...
      "button/regular-primary-text":
        "rgba(224.4, 229.5, 234.6, 0.8999999761581421)",
      "button/regular-primary-text-active": "rgba(226.95, 229.5, 232.05, 1)",
      "button/regular-primary-text-hover":
        "rgba(224.4, 229.5, 234.6, 0.8999999761581421)",
      ...
      "button/regular-secondary-text":
        "rgba(234.6, 224.4, 224.4, 0.8999999761581421)",
      "button/regular-secondary-text-active": "rgba(232.05, 226.95, 226.95, 1)",
      ...
      "input/text-placeholder":
        "rgba(223.13, 229.5, 235.88, 0.44999998807907104)",
      ...
      "search-section/options-text":
        "rgba(223.13, 229.5, 235.87, 0.949999988079071)",
      "search-section/options-text-active":
        "rgba(223.13, 229.5, 235.87, 0.949999988079071)",
